...
pacaur -S --noconfirm --noedit ctags ncurses curl unzip python-neovim neovim go docker docker-compose tmux zsh htop fzf xsel silver-searcher-git tree exa dconf ranger
